 ...
 *
 * This is the single canonical Database type source for the whole project.
 * It lives in the frontend because Vercel only installs/builds
 * cleanlyst-frontend/ — nothing here may import from cleanlyst-backend/.
 *
 * These are hand-written to match the schema defined in
 * cleanlyst-backend/supabase/migrations/. To refresh from the live schema,
 * run from cleanlyst-backend/:
 *   supabase gen types typescript --linked
 * and reconcile the output with this file.
 */
