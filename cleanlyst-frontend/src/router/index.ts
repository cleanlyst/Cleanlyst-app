...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      alias: '/signup/customer',
      name: 'SignupCustomer',
      meta: { title: 'Customer Sign up', redirectIfAuthenticated: true },
      component: () => import('../pages/SignupPage.vue'),
    },
    {
      path: '/auth/signup/cleaner',
      alias: '/signup/cleaner',
      name: 'SignupCleaner',
    ...
    {
      path: '/admin/dashboard/financial-audit',
      name: 'AdminFinancialAudit',
      meta: { title: 'Financial Audit', requiresAuth: true, requiresRole: 'admin' },
      component: () => import('../pages/admin/AdminDashboard.vue'),
    },
    {
