<template>
  <div class="bg-background text-on-background antialiased font-body text-body">
        ...
        <div class="relative flex flex-col md:flex-row gap-16">
          ...
          <aside class="hidden md:block w-64 shrink-0">
            <div class="sticky top-24 space-y-4">
              <h3 class="font-label-md text-label-md text-primary uppercase tracking-wider mb-6">
                Contents
              </h3>
              ...
              <nav class="space-y-3">
                <a
                  href="#introduction"
                  class="block font-label-md text-label-md text-primary border-l-2 border-primary pl-4"
                >
                  1. Introduction
                </a>
          ...
          <div class="flex-1 space-y-16">
            ...
            <!-- Security -->
            <section id="security">
              <h2 class="font-h2 text-h2 text-primary mb-6">5. Security Measures</h2>

              <div
                class="relative w-full h-[300px] mb-8 overflow-hidden rounded-xl border border-outline-variant"
              >
                <img
                  class="w-full h-full object-cover grayscale opacity-20"
                  alt=""
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuDv-iy2cs_vzZdDGjYB4NgEKr2o_vHiGVvlzoayGC80a4lVMiUCiZ5lOpPbqE7J7--zZDsn9YaqSjQaRpai0aLG3zgFk_qfjr6gzqTi_1Gw1lMLnuBS64NtiH09LeJvjUsbUCZzOy_2cxgADxmDTNcrc3ouppQvwIOiZdqKAuw7l8gjMbGhrF3tE0yCtbXQQH1lbeRGB8cJ6geMPXjltnNFpumTeVhSZcB1vqOuvvAm51DOxqqI-KeJX6etZ9V1w5JQMVVVOV2-VQ"
                />

                <div class="absolute inset-0 flex items-center justify-center">
                  <div
                    class="bg-surface-container-lowest/90 p-padding-card border border-outline-variant text-center max-w-sm"
                  >
